...
public class Types {
    ...
    public static ParameterizedType toParameterizedType(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            if(null == genericSuper || Object.class.equals(genericSuper)){
                ...
                if(!Collections.isEmpty(genericInterfaces)){
                    // 默认取第一个实现接口的泛型Type
     ...
     * @since 4.5.7
     */
    public static Type[] getActualTypes111(Type actualType, Class<?> typeDefineClass, Type... typeVariables) {
...
//        if(Collections.isEmpty(typeVars)) {
//            return null;
//        }
//        // 实际类型列表
//        final Type[] actualTypeArguments = Types.getTypeArguments(actualType);
//        if(Collections.isEmpty(actualTypeArguments)) {
//            return null;
//        }
//
