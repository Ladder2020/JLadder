...
public abstract class Times {
    ...
    public static TmInfo Ti(String ts) {
        ...
        throw Core.makeThrow("Wrong format of time string '%s'", ts);
    }
    ...
    public static Date convert(String ds){
    ...
    public static long ams(String ds, TimeZone tz) {
        ...
        throw Core.makeThrow("Unexpect date format '%s'", ds);
    }
    ...
    public static String mss(int ms) {
        int sec = ms / 1000;
        ms = ms - sec * 1000;
        return secs(sec) + "." + Strings.prepend(ms, 3, '0');
    }
    ...
    public static String secs(int sec) {
        ...
        int mm = sec / 60;
        sec -= mm * 60;
        return Strings.prepend(hh, 2, '0')
               + ":"
               + Strings.prepend(mm, 2, '0')
               + ":"
               + Strings.prepend(sec, 2, '0');
    ...
    public static String sT(int sec) {
        int[] ss = T(sec);
        return Strings.prepend(ss[0], 2, '0')
               + ":"
               + Strings.prepend(ss[1], 2, '0')
               + ":"
               + Strings.prepend(ss[2], 2, '0');
    }
    ...
    public static String sTmin(int sec) {
        int[] ss = T(sec);
        return Strings.prepend(ss[0], 2, '0') + ":" + Strings.prepend(ss[1], 2, '0');
    }
